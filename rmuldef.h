...
#define rmul16u(result, multiplicand, multiplier) { \
uint32_t multiplier2 = multiplier; \
asm volatile ( \
"	clr %D0 \n\t" \
"	clr %C0 \n\t" \
"	clr %B0 \n\t" \
...
#define rmul8u(result, multiplicand, multiplier) { \
uint16_t multiplier2 = multiplier; \
asm volatile ( \
"	clr %B0  \n\t" \
"	clr %A0  \n\t" \
"	cp %A1, r1  \n\t" /* if multiplicand==0*/ \
